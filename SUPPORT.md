...
Thanks for using ttcurate! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/dslc-io/ttcurate/issues/new).
...
requests](https://github.com/dslc-io/ttcurate/issues) to make sure the
